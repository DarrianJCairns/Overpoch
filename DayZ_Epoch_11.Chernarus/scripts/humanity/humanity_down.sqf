...
if (_humanity <= -100000) exitWith {"You have reached the minimum humanity we can provide" call dayz_rollingMessages;};
...
if (_wealth < _cost) then {
    ...
    sleep 0.1; [-1000,0] call player_humanityChange;
};